...
QT_MOC_LITERAL(1, 12, 29), // "removeOffLineTcpSocket_Signal"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 12), // "MyTcpSocket*"
QT_MOC_LITERAL(4, 56, 9), // "tcpSocket"
QT_MOC_LITERAL(5, 66, 10), // "receiveMsg"
QT_MOC_LITERAL(6, 77, 13) // "clientOffLine"

    },
    "MyTcpSocket\0removeOffLineTcpSocket_Signal\0"
    "\0MyTcpSocket*\0tcpSocket\0receiveMsg\0"
    "clientOffLine"
};
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removeOffLineTcpSocket_Signal((*reinterpret_cast< MyTcpSocket*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpSocket::removeOffLineTcpSocket_Signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::removeOffLineTcpSocket_Signal(MyTcpSocket * _t1)
{
